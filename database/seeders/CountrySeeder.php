...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $seedCountries = [
            ...
            ["id" => "44", "name" => "Bahamas", "code_2" => "BS", "code_3" => "BHS",],
            ...
            ["id" => "68", "name" => "Bolivia", "code_2" => "BO", "code_3" => "BOL",],
            ...
            ["id" => "136", "name" => "Cayman Islands", "code_2" => "KY", "code_3" => "CYM",],
            ["id" => "140", "name" => "Central African Republic", "code_2" => "CF", "code_3" => "CAF",],
            ...
            ["id" => "174", "name" => "Comoros", "code_2" => "KM", "code_3" => "COM",],
            ...
            ["id" => "214", "name" => "Dominican Republic", "code_2" => "DO", "code_3" => "DOM",],
            ...
            ["id" => "270", "name" => "Gambia", "code_2" => "GM", "code_3" => "GMB",],
            ...
            ["id" => "336", "name" => "Holy See", "code_2" => "VA", "code_3" => "VAT",],
            ...
            ["id" => "364", "name" => "Iran", "code_2" => "IR", "code_3" => "IRN",],
            ...
            ["id" => "408", "name" => "Korea (North)", "code_2" => "KP", "code_3" => "PRK",],
            ["id" => "410", "name" => "Korea (South)", "code_2" => "KR", "code_3" => "KOR",],
            ...
            ["id" => "498", "name" => "Moldova", "code_2" => "MD", "code_3" => "MDA",],
            ...
            ["id" => "528", "name" => "Netherlands", "code_2" => "NL", "code_3" => "NLD",],
            ...
            ["id" => "562", "name" => "Niger", "code_2" => "NE", "code_3" => "NER",],
            ...
            ["id" => "275", "name" => "Palestine", "code_2" => "PS", "code_3" => "PSE",],
            ...
            ["id" => "608", "name" => "Philippines", "code_2" => "PH", "code_3" => "PHL",],
            ["id" => "612", "name" => "Pitcairn Island", "code_2" => "PN", "code_3" => "PCN",],
            ...
            ["id" => "643", "name" => "Russian Federation", "code_2" => "RU", "code_3" => "RUS",],
            ...
            ["id" => "663", "name" => "Saint Martin (France)", "code_2" => "MF", "code_3" => "MAF",],
            ...
            ["id" => "729", "name" => "Sudan", "code_2" => "SD", "code_3" => "SDN",],
            ...
            ["id" => "834", "name" => "Tanzania", "code_2" => "TZ", "code_3" => "TZA",],
            ...
            ["id" => "796", "name" => "Turks and Caicos Islands", "code_2" => "TC", "code_3" => "TCA",],
            ["id" => "798", "name" => "Tuvalu", "code_2" => "TV", "code_3" => "TUV",],
            ["id" => "800", "name" => "Uganda", "code_2" => "UG", "code_3" => "UGA",],
            ["id" => "804", "name" => "Ukraine", "code_2" => "UA", "code_3" => "UKR",],
            ["id" => "784", "name" => "United Arab Emirates", "code_2" => "AE", "code_3" => "ARE",],
            ["id" => "826", "name" => "United Kingdom of Great Britain and Northern Ireland", "code_2" => "GB", "code_3" => "GBR",],
            ["id" => "840", "name" => "United States of America", "code_2" => "US", "code_3" => "USA",],
            ...
            ["id" => "862", "name" => "Venezuela", "code_2" => "VE", "code_3" => "VEN",],
            ["id" => "704", "name" => "Vietnam", "code_2" => "VN", "code_3" => "VNM",],
        ...
        foreach ($seedCountries as $item) {
            $country['id'] = $item['id'];
            $country['name'] = $item['name'];
            $country['code_2'] = $item['code_2'];
            $country['code_3'] = $item['code_3'];
